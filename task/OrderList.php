...
<body>
	<div class = "page-wrap">
		...
		<?php 
			...
			echo "<form>";
			echo "<p>Enter a order ID to search:</p><br/>";
			...
			echo "<br/><a href = 'OrderList.php?page=$nextPage&search=$safeSearchString'>Next Page-></a>";
			echo "</div>";

			$previousPage = $currentPage - 1;
			if ($currentPage>0)
			{
				echo "<a href = 'OrderList.php?page=$previousPage&search=$safeSearchString'><div id='alignment'><-Previous Page</div></a>";
				echo "<br/>";
			}
			...
			while($row = $statement->fetch(PDO::FETCH_ASSOC))
			{
				...
				$TimeStamp = makeOutputSafe(date("Y/m/d h:i A",$row['TimeStamp']));
				...
				echo "<div id= table>";
				echo "<table>";
				echo "<tr><th> <a href='ViewOrderDetails2.php?OrderID=$OrderID'> OrderID </a> </th><td> $OrderID </td></tr>";
